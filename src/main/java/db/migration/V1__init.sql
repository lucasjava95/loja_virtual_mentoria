...
if (existe <=0) then
    ...
    RAISE EXCEPTION 'Não foi encontrado ID ou PK da pessoa para associar ao cadastro';
...
if (existe <=0) then
    ...
    RAISE EXCEPTION 'Não foi encontrado ID e PK da pessoa para associar ao cadastro';
...
CREATE TABLE public.pessoa_juridica (
    ...
    inscric_estadual character varying(255) NOT NULL,
    inscric_municipal character varying(255),
...
INSERT INTO public.avaliacao_produto (id, descricao, nota, pessoa_id, produto_id) VALUES (1, 'teste avaliacao', 10, 1, 1);
INSERT INTO public.avaliacao_produto (id, descricao, nota, pessoa_id, produto_id) VALUES (2, 'teste avaliacao', 10, 1, 1);
INSERT INTO public.avaliacao_produto (id, descricao, nota, pessoa_id, produto_id) VALUES (3, 'teste avaliacao', 10, 1, 1);
...
INSERT INTO public.pessoa_fisica (id, email, nome, telefone, cpf, data_nascimento) VALUES (1, 'alex.egidio@gmail.com', 'Alex', '(98)98338-5253', '232.232.232-34', '2000-04-22');
...
INSERT INTO public.produto (id, alerta_qtd_estoque, altura, ativo, descricao, largura, link_yotube, nome, peso, profundidade, qtd_alerta_estoque, qtd_clique, qtd_estoque, tipo_unidade, valor_venda) VALUES (1, true, 5, true, 'Tênis de alta qualidade', 5.2000000000000002, '', 'tênis Adidas', 20.5, 8.1999999999999993, 10, 200, 20, 'unidade', 99.90);
...
--
-- Name: uk5t4np5rpqhk9809fgd2jvlf0l; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.nota_fiscal_compra
    ADD CONSTRAINT uk5t4np5rpqhk9809fgd2jvlf0l UNIQUE (conta_pagar_id);
